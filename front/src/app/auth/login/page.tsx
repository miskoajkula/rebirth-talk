...
const Page = () => {
  ...
  const eyeCss = classNames(
    "w-5 h-5 absolute right-4 opacity-70 text-black top-9 hover:cursor-pointer",
    {
  ...
  return (
    <AuthLayout>
      ...
      <div className={"flex items-center"}>
        <h2 className="text-sm  font-semibold text-gray-400 mt-0">
      ...
      <form className="space-y-4 mt-6" onSubmit={handleSubmit(onSubmit)}>
        <div className={"relative"}>
          <Input
            ...
            errors={errors}
          />
          <EyeIcon onClick={onInputTypeChange} className={eyeCss} />
        </div>
